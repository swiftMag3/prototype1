...
//  Periodic Table
//
//  Created by Swift Mage on 10/12/2017.
...
public class PeriodicTableBackground : NSObject {
    ...
    @objc dynamic public class func drawIphone5landscape(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 568, height: 320), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        
        //// Resize to Target Frame
        context.saveGState()
        let resizedFrame: CGRect = resizing.apply(rect: CGRect(x: 0, y: 0, width: 568, height: 320), target: targetFrame)
        context.translateBy(x: resizedFrame.minX, y: resizedFrame.minY)
        context.scaleBy(x: resizedFrame.width / 568, y: resizedFrame.height / 320)


        //// Element 1 Drawing
        let element1Path = UIBezierPath(rect: CGRect(x: 15, y: 30, width: 30, height: 30))
        PeriodicTableBackground.hydrogenColor.setFill()
        element1Path.fill()


        //// Element 3 Drawing
        let element3Path = UIBezierPath(rect: CGRect(x: 15, y: 60, width: 30, height: 31))
        PeriodicTableBackground.alkaliMetalsColor.setFill()
        element3Path.fill()


        //// Element 11 Drawing
        let element11Path = UIBezierPath(rect: CGRect(x: 15, y: 91, width: 30, height: 30))
        PeriodicTableBackground.alkaliMetalsColor.setFill()
        element11Path.fill()


        //// Element 19 Drawing
        let element19Path = UIBezierPath(rect: CGRect(x: 15, y: 121, width: 30, height: 31))
        PeriodicTableBackground.alkaliMetalsColor.setFill()
        element19Path.fill()


        //// Element 37 Drawing
        let element37Path = UIBezierPath(rect: CGRect(x: 15, y: 152, width: 30, height: 30))
        PeriodicTableBackground.alkaliMetalsColor.setFill()
        element37Path.fill()


        //// Element 55 Drawing
        let element55Path = UIBezierPath(rect: CGRect(x: 15, y: 182, width: 30, height: 31))
        PeriodicTableBackground.alkaliMetalsColor.setFill()
        element55Path.fill()


        //// Element 87 Drawing
        let element87Path = UIBezierPath(rect: CGRect(x: 15, y: 213, width: 30, height: 30))
        PeriodicTableBackground.alkaliMetalsColor.setFill()
        element87Path.fill()


        //// Element 4 Drawing
        let element4Path = UIBezierPath(rect: CGRect(x: 45, y: 60, width: 31, height: 31))
        PeriodicTableBackground.alkalineEarthMetalsColor.setFill()
        element4Path.fill()


        //// Element 12 Drawing
        let element12Path = UIBezierPath(rect: CGRect(x: 45, y: 91, width: 31, height: 30))
        PeriodicTableBackground.alkalineEarthMetalsColor.setFill()
        element12Path.fill()


        //// Element 20 Drawing
        let element20Path = UIBezierPath(rect: CGRect(x: 45, y: 121, width: 31, height: 31))
        PeriodicTableBackground.alkalineEarthMetalsColor.setFill()
        element20Path.fill()


        //// Element 38 Drawing
        let element38Path = UIBezierPath(rect: CGRect(x: 45, y: 152, width: 31, height: 30))
        PeriodicTableBackground.alkalineEarthMetalsColor.setFill()
        element38Path.fill()


        //// Element 56 Drawing
        let element56Path = UIBezierPath(rect: CGRect(x: 45, y: 182, width: 31, height: 31))
        PeriodicTableBackground.alkalineEarthMetalsColor.setFill()
        element56Path.fill()


        //// Element 88 Drawing
        let element88Path = UIBezierPath(rect: CGRect(x: 45, y: 213, width: 31, height: 30))
        PeriodicTableBackground.alkalineEarthMetalsColor.setFill()
        element88Path.fill()


        //// Element 21 Drawing
        let element21Path = UIBezierPath(rect: CGRect(x: 76, y: 121, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element21Path.fill()


        //// Element 39 Drawing
        let element39Path = UIBezierPath(rect: CGRect(x: 76, y: 152, width: 30, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element39Path.fill()


        //// Lanthanoids Cell Drawing
        let lanthanoidsCellPath = UIBezierPath(rect: CGRect(x: 76, y: 182, width: 30, height: 31))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        lanthanoidsCellPath.fill()


        //// Actinoids Cell Drawing
        let actinoidsCellPath = UIBezierPath(rect: CGRect(x: 76, y: 213, width: 30, height: 30))
        PeriodicTableBackground.actinoidsColor.setFill()
        actinoidsCellPath.fill()


        //// Element 22 Drawing
        let element22Path = UIBezierPath(rect: CGRect(x: 106, y: 121, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element22Path.fill()


        //// Element 40 Drawing
        let element40Path = UIBezierPath(rect: CGRect(x: 106, y: 152, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element40Path.fill()


        //// Element 72 Drawing
        let element72Path = UIBezierPath(rect: CGRect(x: 106, y: 182, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element72Path.fill()


        //// Element 104 Drawing
        let element104Path = UIBezierPath(rect: CGRect(x: 106, y: 213, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element104Path.fill()


        //// Element 23 Drawing
        let element23Path = UIBezierPath(rect: CGRect(x: 137, y: 121, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element23Path.fill()


        //// Element 41 Drawing
        let element41Path = UIBezierPath(rect: CGRect(x: 137, y: 152, width: 30, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element41Path.fill()


        //// Element 73 Drawing
        let element73Path = UIBezierPath(rect: CGRect(x: 137, y: 182, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element73Path.fill()


        //// Element 105 Drawing
        let element105Path = UIBezierPath(rect: CGRect(x: 137, y: 213, width: 30, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element105Path.fill()


        //// Element 24 Drawing
        let element24Path = UIBezierPath(rect: CGRect(x: 167, y: 121, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element24Path.fill()


        //// Element 42 Drawing
        let element42Path = UIBezierPath(rect: CGRect(x: 167, y: 152, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element42Path.fill()


        //// Element 74 Drawing
        let element74Path = UIBezierPath(rect: CGRect(x: 167, y: 182, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element74Path.fill()


        //// Element 106 Drawing
        let element106Path = UIBezierPath(rect: CGRect(x: 167, y: 213, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element106Path.fill()


        //// Element 25 Drawing
        let element25Path = UIBezierPath(rect: CGRect(x: 198, y: 121, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element25Path.fill()


        //// Element 43 Drawing
        let element43Path = UIBezierPath(rect: CGRect(x: 198, y: 152, width: 30, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element43Path.fill()


        //// Element 75 Drawing
        let element75Path = UIBezierPath(rect: CGRect(x: 198, y: 182, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element75Path.fill()


        //// Element 107 Drawing
        let element107Path = UIBezierPath(rect: CGRect(x: 198, y: 213, width: 30, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element107Path.fill()


        //// Element 26 Drawing
        let element26Path = UIBezierPath(rect: CGRect(x: 228, y: 121, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element26Path.fill()


        //// Element 44 Drawing
        let element44Path = UIBezierPath(rect: CGRect(x: 228, y: 152, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element44Path.fill()


        //// Element 76 Drawing
        let element76Path = UIBezierPath(rect: CGRect(x: 228, y: 182, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element76Path.fill()


        //// Element 108 Drawing
        let element108Path = UIBezierPath(rect: CGRect(x: 228, y: 213, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element108Path.fill()


        //// Element 27 Drawing
        let element27Path = UIBezierPath(rect: CGRect(x: 259, y: 121, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element27Path.fill()


        //// Element 45 Drawing
        let element45Path = UIBezierPath(rect: CGRect(x: 259, y: 152, width: 30, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element45Path.fill()


        //// Element 77 Drawing
        let element77Path = UIBezierPath(rect: CGRect(x: 259, y: 182, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element77Path.fill()


        //// Element 109 Drawing
        let element109Path = UIBezierPath(rect: CGRect(x: 259, y: 213, width: 30, height: 30))
        PeriodicTableBackground.unknownColor.setFill()
        element109Path.fill()


        //// Element 28 Drawing
        let element28Path = UIBezierPath(rect: CGRect(x: 289, y: 121, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element28Path.fill()


        //// Element 46 Drawing
        let element46Path = UIBezierPath(rect: CGRect(x: 289, y: 152, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element46Path.fill()


        //// Element 78 Drawing
        let element78Path = UIBezierPath(rect: CGRect(x: 289, y: 182, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element78Path.fill()


        //// Element 110 Drawing
        let element110Path = UIBezierPath(rect: CGRect(x: 289, y: 213, width: 31, height: 30))
        PeriodicTableBackground.unknownColor.setFill()
        element110Path.fill()


        //// Element 29 Drawing
        let element29Path = UIBezierPath(rect: CGRect(x: 320, y: 121, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element29Path.fill()


        //// Element 47 Drawing
        let element47Path = UIBezierPath(rect: CGRect(x: 320, y: 152, width: 30, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element47Path.fill()


        //// Element 79 Drawing
        let element79Path = UIBezierPath(rect: CGRect(x: 320, y: 182, width: 30, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element79Path.fill()


        //// Element 111 Drawing
        let element111Path = UIBezierPath(rect: CGRect(x: 320, y: 213, width: 30, height: 30))
        PeriodicTableBackground.unknownColor.setFill()
        element111Path.fill()


        //// Element 30 Drawing
        let element30Path = UIBezierPath(rect: CGRect(x: 350, y: 121, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element30Path.fill()


        //// Element 48 Drawing
        let element48Path = UIBezierPath(rect: CGRect(x: 350, y: 152, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element48Path.fill()


        //// Element 80 Drawing
        let element80Path = UIBezierPath(rect: CGRect(x: 350, y: 182, width: 31, height: 31))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element80Path.fill()


        //// Element 112 Drawing
        let element112Path = UIBezierPath(rect: CGRect(x: 350, y: 213, width: 31, height: 30))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        element112Path.fill()


        //// Element 31 Drawing
        let element31Path = UIBezierPath(rect: CGRect(x: 381, y: 121, width: 30, height: 31))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element31Path.fill()


        //// Element 13 Drawing
        let element13Path = UIBezierPath(rect: CGRect(x: 381, y: 91, width: 30, height: 30))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element13Path.fill()


        //// Element 49 Drawing
        let element49Path = UIBezierPath(rect: CGRect(x: 381, y: 152, width: 30, height: 30))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element49Path.fill()


        //// Element 81 Drawing
        let element81Path = UIBezierPath(rect: CGRect(x: 381, y: 182, width: 30, height: 31))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element81Path.fill()


        //// Element 5 Drawing
        let element5Path = UIBezierPath(rect: CGRect(x: 381, y: 60, width: 30, height: 31))
        PeriodicTableBackground.metalloidsColor.setFill()
        element5Path.fill()


        //// Element 113 Drawing
        let element113Path = UIBezierPath(rect: CGRect(x: 381, y: 213, width: 30, height: 30))
        PeriodicTableBackground.unknownColor.setFill()
        element113Path.fill()


        //// Element 32 Drawing
        let element32Path = UIBezierPath(rect: CGRect(x: 411, y: 121, width: 31, height: 31))
        PeriodicTableBackground.metalloidsColor.setFill()
        element32Path.fill()


        //// Element 14 Drawing
        let element14Path = UIBezierPath(rect: CGRect(x: 411, y: 91, width: 31, height: 30))
        PeriodicTableBackground.metalloidsColor.setFill()
        element14Path.fill()


        //// Element 50 Drawing
        let element50Path = UIBezierPath(rect: CGRect(x: 411, y: 152, width: 31, height: 30))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element50Path.fill()


        //// Element 82 Drawing
        let element82Path = UIBezierPath(rect: CGRect(x: 411, y: 182, width: 31, height: 31))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element82Path.fill()


        //// Element 6 Drawing
        let element6Path = UIBezierPath(rect: CGRect(x: 411, y: 60, width: 31, height: 31))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element6Path.fill()


        //// Element 114 Drawing
        let element114Path = UIBezierPath(rect: CGRect(x: 411, y: 213, width: 31, height: 30))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element114Path.fill()


        //// Element 33 Drawing
        let element33Path = UIBezierPath(rect: CGRect(x: 442, y: 121, width: 30, height: 31))
        PeriodicTableBackground.metalloidsColor.setFill()
        element33Path.fill()


        //// Element 15 Drawing
        let element15Path = UIBezierPath(rect: CGRect(x: 442, y: 91, width: 30, height: 30))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element15Path.fill()


        //// Element 51 Drawing
        let element51Path = UIBezierPath(rect: CGRect(x: 442, y: 152, width: 30, height: 30))
        PeriodicTableBackground.metalloidsColor.setFill()
        element51Path.fill()


        //// Element 83 Drawing
        let element83Path = UIBezierPath(rect: CGRect(x: 442, y: 182, width: 30, height: 31))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element83Path.fill()


        //// Element 7 Drawing
        let element7Path = UIBezierPath(rect: CGRect(x: 442, y: 60, width: 30, height: 31))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element7Path.fill()


        //// Element 115 Drawing
        let element115Path = UIBezierPath(rect: CGRect(x: 442, y: 213, width: 30, height: 30))
        PeriodicTableBackground.unknownColor.setFill()
        element115Path.fill()


        //// Element 34 Drawing
        let element34Path = UIBezierPath(rect: CGRect(x: 472, y: 121, width: 31, height: 31))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element34Path.fill()


        //// Element 16 Drawing
        let element16Path = UIBezierPath(rect: CGRect(x: 472, y: 91, width: 31, height: 30))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element16Path.fill()


        //// Element 52 Drawing
        let element52Path = UIBezierPath(rect: CGRect(x: 472, y: 152, width: 31, height: 30))
        PeriodicTableBackground.metalloidsColor.setFill()
        element52Path.fill()


        //// Element 84 Drawing
        let element84Path = UIBezierPath(rect: CGRect(x: 472, y: 182, width: 31, height: 31))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        element84Path.fill()


        //// Element 8 Drawing
        let element8Path = UIBezierPath(rect: CGRect(x: 472, y: 60, width: 31, height: 31))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element8Path.fill()


        //// Element 116 Drawing
        let element116Path = UIBezierPath(rect: CGRect(x: 472, y: 213, width: 31, height: 30))
        PeriodicTableBackground.unknownColor.setFill()
        element116Path.fill()


        //// Element 35 Drawing
        let element35Path = UIBezierPath(rect: CGRect(x: 503, y: 121, width: 30, height: 31))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element35Path.fill()


        //// Element 17 Drawing
        let element17Path = UIBezierPath(rect: CGRect(x: 503, y: 91, width: 30, height: 30))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element17Path.fill()


        //// Element 53 Drawing
        let element53Path = UIBezierPath(rect: CGRect(x: 503, y: 152, width: 30, height: 30))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element53Path.fill()


        //// Element 85 Drawing
        let element85Path = UIBezierPath(rect: CGRect(x: 503, y: 182, width: 30, height: 31))
        PeriodicTableBackground.metalloidsColor.setFill()
        element85Path.fill()


        //// Element 9 Drawing
        let element9Path = UIBezierPath(rect: CGRect(x: 503, y: 60, width: 30, height: 31))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        element9Path.fill()


        //// Element 117 Drawing
        let element117Path = UIBezierPath(rect: CGRect(x: 503, y: 213, width: 30, height: 30))
        PeriodicTableBackground.unknownColor.setFill()
        element117Path.fill()


        //// Element 36 Drawing
        let element36Path = UIBezierPath(rect: CGRect(x: 533, y: 121, width: 31, height: 31))
        PeriodicTableBackground.nobleGasesColor.setFill()
        element36Path.fill()


        //// Element 18 Drawing
        let element18Path = UIBezierPath(rect: CGRect(x: 533, y: 91, width: 31, height: 30))
        PeriodicTableBackground.nobleGasesColor.setFill()
        element18Path.fill()


        //// Element 54 Drawing
        let element54Path = UIBezierPath(rect: CGRect(x: 533, y: 152, width: 31, height: 30))
        PeriodicTableBackground.nobleGasesColor.setFill()
        element54Path.fill()


        //// Element 86 Drawing
        let element86Path = UIBezierPath(rect: CGRect(x: 533, y: 182, width: 31, height: 31))
        PeriodicTableBackground.nobleGasesColor.setFill()
        element86Path.fill()


        //// Element 10 Drawing
        let element10Path = UIBezierPath(rect: CGRect(x: 533, y: 60, width: 31, height: 31))
        PeriodicTableBackground.nobleGasesColor.setFill()
        element10Path.fill()


        //// Element 118 Drawing
        let element118Path = UIBezierPath(rect: CGRect(x: 533, y: 213, width: 31, height: 30))
        PeriodicTableBackground.unknownColor.setFill()
        element118Path.fill()


        //// Element 2 Drawing
        let element2Path = UIBezierPath(rect: CGRect(x: 533, y: 30, width: 31, height: 30))
        PeriodicTableBackground.nobleGasesColor.setFill()
        element2Path.fill()


        //// Element 57 Drawing
        let element57Path = UIBezierPath(rect: CGRect(x: 106, y: 253, width: 31, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element57Path.fill()


        //// Element 58 Drawing
        let element58Path = UIBezierPath(rect: CGRect(x: 137, y: 253, width: 30, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element58Path.fill()


        //// Element 59 Drawing
        let element59Path = UIBezierPath(rect: CGRect(x: 167, y: 253, width: 31, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element59Path.fill()


        //// Element 60 Drawing
        let element60Path = UIBezierPath(rect: CGRect(x: 198, y: 253, width: 30, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element60Path.fill()


        //// Element 61 Drawing
        let element61Path = UIBezierPath(rect: CGRect(x: 228, y: 253, width: 31, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element61Path.fill()


        //// Element 62 Drawing
        let element62Path = UIBezierPath(rect: CGRect(x: 259, y: 253, width: 30, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element62Path.fill()


        //// Element 63 Drawing
        let element63Path = UIBezierPath(rect: CGRect(x: 289, y: 253, width: 31, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element63Path.fill()


        //// Element 64 Drawing
        let element64Path = UIBezierPath(rect: CGRect(x: 320, y: 253, width: 30, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element64Path.fill()


        //// Element 65 Drawing
        let element65Path = UIBezierPath(rect: CGRect(x: 350, y: 253, width: 31, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element65Path.fill()


        //// Element 66 Drawing
        let element66Path = UIBezierPath(rect: CGRect(x: 381, y: 253, width: 30, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element66Path.fill()


        //// Element 67 Drawing
        let element67Path = UIBezierPath(rect: CGRect(x: 411, y: 253, width: 31, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element67Path.fill()


        //// Element 68 Drawing
        let element68Path = UIBezierPath(rect: CGRect(x: 442, y: 253, width: 30, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element68Path.fill()


        //// Element 69 Drawing
        let element69Path = UIBezierPath(rect: CGRect(x: 472, y: 253, width: 31, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element69Path.fill()


        //// Element 70 Drawing
        let element70Path = UIBezierPath(rect: CGRect(x: 503, y: 253, width: 30, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element70Path.fill()


        //// Element 71 Drawing
        let element71Path = UIBezierPath(rect: CGRect(x: 533, y: 253, width: 31, height: 30))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        element71Path.fill()


        //// Element Drawing
        let elementPath = UIBezierPath(rect: CGRect(x: 533, y: 283, width: 31, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        elementPath.fill()


        //// Element 89 Drawing
        let element89Path = UIBezierPath(rect: CGRect(x: 106, y: 283, width: 31, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element89Path.fill()


        //// Element 90 Drawing
        let element90Path = UIBezierPath(rect: CGRect(x: 137, y: 283, width: 30, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element90Path.fill()


        //// Element 91 Drawing
        let element91Path = UIBezierPath(rect: CGRect(x: 167, y: 283, width: 31, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element91Path.fill()


        //// Element 92 Drawing
        let element92Path = UIBezierPath(rect: CGRect(x: 198, y: 283, width: 30, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element92Path.fill()


        //// Element 93 Drawing
        let element93Path = UIBezierPath(rect: CGRect(x: 228, y: 283, width: 31, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element93Path.fill()


        //// Element 94 Drawing
        let element94Path = UIBezierPath(rect: CGRect(x: 259, y: 283, width: 30, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element94Path.fill()


        //// Element 95 Drawing
        let element95Path = UIBezierPath(rect: CGRect(x: 289, y: 283, width: 31, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element95Path.fill()


        //// Element 96 Drawing
        let element96Path = UIBezierPath(rect: CGRect(x: 320, y: 283, width: 30, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element96Path.fill()


        //// Element 97 Drawing
        let element97Path = UIBezierPath(rect: CGRect(x: 350, y: 283, width: 31, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element97Path.fill()


        //// Element 98 Drawing
        let element98Path = UIBezierPath(rect: CGRect(x: 381, y: 283, width: 30, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element98Path.fill()


        //// Element 99 Drawing
        let element99Path = UIBezierPath(rect: CGRect(x: 411, y: 283, width: 31, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element99Path.fill()


        //// Element 100 Drawing
        let element100Path = UIBezierPath(rect: CGRect(x: 442, y: 283, width: 30, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element100Path.fill()


        //// Element 101 Drawing
        let element101Path = UIBezierPath(rect: CGRect(x: 472, y: 283, width: 31, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element101Path.fill()


        //// Element 102 Drawing
        let element102Path = UIBezierPath(rect: CGRect(x: 503, y: 283, width: 30, height: 31))
        PeriodicTableBackground.actinoidsColor.setFill()
        element102Path.fill()


        //// Period1Label Drawing
        let period1LabelRect = CGRect(x: 0, y: 36, width: 15, height: 18)
        let period1LabelTextContent = "1"
        let period1LabelStyle = NSMutableParagraphStyle()
        period1LabelStyle.alignment = .center
        let period1LabelFontAttributes = [
        ...
        //// Period1Label 2 Drawing
        let period1Label2Rect = CGRect(x: 0, y: 66, width: 15, height: 19)
        let period1Label2TextContent = "2"
        let period1Label2Style = NSMutableParagraphStyle()
        period1Label2Style.alignment = .center
        let period1Label2FontAttributes = [
        ...
        //// Period1Label 3 Drawing
        let period1Label3Rect = CGRect(x: 0, y: 97, width: 15, height: 18)
        let period1Label3TextContent = "3"
        let period1Label3Style = NSMutableParagraphStyle()
        period1Label3Style.alignment = .center
        let period1Label3FontAttributes = [
        ...
        //// Period1Label 4 Drawing
        let period1Label4Rect = CGRect(x: 0, y: 127, width: 15, height: 19)
        let period1Label4TextContent = "4"
        let period1Label4Style = NSMutableParagraphStyle()
        period1Label4Style.alignment = .center
        let period1Label4FontAttributes = [
        ...
        //// Period1Label 5 Drawing
        let period1Label5Rect = CGRect(x: 0, y: 158, width: 15, height: 18)
        let period1Label5TextContent = "5"
        let period1Label5Style = NSMutableParagraphStyle()
        period1Label5Style.alignment = .center
        let period1Label5FontAttributes = [
        ...
        //// Period1Label 6 Drawing
        let period1Label6Rect = CGRect(x: 0, y: 188, width: 15, height: 19)
        let period1Label6TextContent = "6"
        let period1Label6Style = NSMutableParagraphStyle()
        period1Label6Style.alignment = .center
        let period1Label6FontAttributes = [
        ...
        //// Period1Label 7 Drawing
        let period1Label7Rect = CGRect(x: 0, y: 219, width: 15, height: 18)
        let period1Label7TextContent = "7"
        let period1Label7Style = NSMutableParagraphStyle()
        period1Label7Style.alignment = .center
        let period1Label7FontAttributes = [
        ...
        //// Group 1 Drawing
        let group1Rect = CGRect(x: 15, y: 12, width: 30, height: 18)
        let group1TextContent = "IA"
        let group1Style = NSMutableParagraphStyle()
        group1Style.alignment = .center
        let group1FontAttributes = [
        ...
        //// Group 2 Drawing
        let group2Rect = CGRect(x: 46, y: 12, width: 31, height: 18)
        let group2TextContent = "IIA"
        let group2Style = NSMutableParagraphStyle()
        group2Style.alignment = .center
        let group2FontAttributes = [
        ...
        //// Group 3 Drawing
        let group3Rect = CGRect(x: 77, y: 12, width: 30, height: 18)
        let group3TextContent = "IIIB"
        let group3Style = NSMutableParagraphStyle()
        group3Style.alignment = .center
        let group3FontAttributes = [
        ...
        //// Group 4 Drawing
        let group4Rect = CGRect(x: 106, y: 12, width: 31, height: 18)
        let group4TextContent = "IVB"
        let group4Style = NSMutableParagraphStyle()
        group4Style.alignment = .center
        let group4FontAttributes = [
        ...
        //// Group 5 Drawing
        let group5Rect = CGRect(x: 137, y: 12, width: 30, height: 18)
        let group5TextContent = "VB"
        let group5Style = NSMutableParagraphStyle()
        group5Style.alignment = .center
        let group5FontAttributes = [
        ...
        //// Group 6 Drawing
        let group6Rect = CGRect(x: 167, y: 12, width: 31, height: 18)
        let group6TextContent = "VIB"
        let group6Style = NSMutableParagraphStyle()
        group6Style.alignment = .center
        let group6FontAttributes = [
        ...
        //// Group 7 Drawing
        let group7Rect = CGRect(x: 198, y: 12, width: 30, height: 18)
        let group7TextContent = "VIIB"
        let group7Style = NSMutableParagraphStyle()
        group7Style.alignment = .center
        let group7FontAttributes = [
        ...
        //// Group 8 Drawing
        let group8Rect = CGRect(x: 228, y: 12, width: 92, height: 18)
        let group8TextContent = "VIIIB"
        let group8Style = NSMutableParagraphStyle()
        group8Style.alignment = .center
        let group8FontAttributes = [
        ...
        //// Group 11 Drawing
        let group11Rect = CGRect(x: 320, y: 12, width: 30, height: 18)
        let group11TextContent = "IB"
        let group11Style = NSMutableParagraphStyle()
        group11Style.alignment = .center
        let group11FontAttributes = [
        ...
        //// Group 12 Drawing
        let group12Rect = CGRect(x: 350, y: 12, width: 31, height: 18)
        let group12TextContent = "IIB"
        let group12Style = NSMutableParagraphStyle()
        group12Style.alignment = .center
        let group12FontAttributes = [
        ...
        //// Group 13 Drawing
        let group13Rect = CGRect(x: 381, y: 12, width: 30, height: 18)
        let group13TextContent = "IIIA"
        let group13Style = NSMutableParagraphStyle()
        group13Style.alignment = .center
        let group13FontAttributes = [
        ...
        //// Group 14 Drawing
        let group14Rect = CGRect(x: 411, y: 12, width: 31, height: 18)
        let group14TextContent = "IVA"
        let group14Style = NSMutableParagraphStyle()
        group14Style.alignment = .center
        let group14FontAttributes = [
        ...
        //// Group 15 Drawing
        let group15Rect = CGRect(x: 442, y: 12, width: 30, height: 18)
        let group15TextContent = "VA"
        let group15Style = NSMutableParagraphStyle()
        group15Style.alignment = .center
        let group15FontAttributes = [
        ...
        //// Group 16 Drawing
        let group16Rect = CGRect(x: 472, y: 12, width: 31, height: 18)
        let group16TextContent = "VIA"
        let group16Style = NSMutableParagraphStyle()
        group16Style.alignment = .center
        let group16FontAttributes = [
        ...
        //// Group 17 Drawing
        let group17Rect = CGRect(x: 503, y: 12, width: 30, height: 18)
        let group17TextContent = "VIIA"
        let group17Style = NSMutableParagraphStyle()
        group17Style.alignment = .center
        let group17FontAttributes = [
        ...
        //// Group 18 Drawing
        let group18Rect = CGRect(x: 533, y: 12, width: 31, height: 18)
        let group18TextContent = "VIIIA"
        let group18Style = NSMutableParagraphStyle()
        group18Style.alignment = .center
        let group18FontAttributes = [
        ...
        //// IUPAC Group 1 Drawing
        let iUPACGroup1Rect = CGRect(x: 15, y: 0, width: 30, height: 17)
        let iUPACGroup1TextContent = "1"
        let iUPACGroup1Style = NSMutableParagraphStyle()
        iUPACGroup1Style.alignment = .center
        let iUPACGroup1FontAttributes = [
        ...
        //// IUPAC Group 2 Drawing
        let iUPACGroup2Rect = CGRect(x: 46, y: 0, width: 31, height: 17)
        let iUPACGroup2TextContent = "2"
        let iUPACGroup2Style = NSMutableParagraphStyle()
        iUPACGroup2Style.alignment = .center
        let iUPACGroup2FontAttributes = [
        ...
        //// IUPAC Group 3 Drawing
        let iUPACGroup3Rect = CGRect(x: 77, y: 0, width: 30, height: 17)
        let iUPACGroup3TextContent = "3"
        let iUPACGroup3Style = NSMutableParagraphStyle()
        iUPACGroup3Style.alignment = .center
        let iUPACGroup3FontAttributes = [
        ...
        //// IUPAC Group 4 Drawing
        let iUPACGroup4Rect = CGRect(x: 106, y: 0, width: 31, height: 17)
        let iUPACGroup4TextContent = "4"
        let iUPACGroup4Style = NSMutableParagraphStyle()
        iUPACGroup4Style.alignment = .center
        let iUPACGroup4FontAttributes = [
        ...
        //// IUPAC Group 5 Drawing
        let iUPACGroup5Rect = CGRect(x: 137, y: 0, width: 30, height: 17)
        let iUPACGroup5TextContent = "5"
        let iUPACGroup5Style = NSMutableParagraphStyle()
        iUPACGroup5Style.alignment = .center
        let iUPACGroup5FontAttributes = [
        ...
        //// IUPAC Group 6 Drawing
        let iUPACGroup6Rect = CGRect(x: 167, y: 0, width: 31, height: 17)
        let iUPACGroup6TextContent = "6"
        let iUPACGroup6Style = NSMutableParagraphStyle()
        iUPACGroup6Style.alignment = .center
        let iUPACGroup6FontAttributes = [
        ...
        //// IUPAC Group 7 Drawing
        let iUPACGroup7Rect = CGRect(x: 198, y: 0, width: 30, height: 17)
        let iUPACGroup7TextContent = "7"
        let iUPACGroup7Style = NSMutableParagraphStyle()
        iUPACGroup7Style.alignment = .center
        let iUPACGroup7FontAttributes = [
        ...
        //// IUPAC Group 11 Drawing
        let iUPACGroup11Rect = CGRect(x: 320, y: 0, width: 30, height: 17)
        let iUPACGroup11TextContent = "11"
        let iUPACGroup11Style = NSMutableParagraphStyle()
        iUPACGroup11Style.alignment = .center
        let iUPACGroup11FontAttributes = [
        ...
        //// IUPAC Group 12 Drawing
        let iUPACGroup12Rect = CGRect(x: 350, y: 0, width: 31, height: 17)
        let iUPACGroup12TextContent = "12"
        let iUPACGroup12Style = NSMutableParagraphStyle()
        iUPACGroup12Style.alignment = .center
        let iUPACGroup12FontAttributes = [
        ...
        //// IUPAC Group 13 Drawing
        let iUPACGroup13Rect = CGRect(x: 381, y: 0, width: 30, height: 17)
        let iUPACGroup13TextContent = "13"
        let iUPACGroup13Style = NSMutableParagraphStyle()
        iUPACGroup13Style.alignment = .center
        let iUPACGroup13FontAttributes = [
        ...
        //// IUPAC Group 14 Drawing
        let iUPACGroup14Rect = CGRect(x: 411, y: 0, width: 31, height: 17)
        let iUPACGroup14TextContent = "14"
        let iUPACGroup14Style = NSMutableParagraphStyle()
        iUPACGroup14Style.alignment = .center
        let iUPACGroup14FontAttributes = [
        ...
        //// IUPAC Group 15 Drawing
        let iUPACGroup15Rect = CGRect(x: 442, y: 0, width: 30, height: 17)
        let iUPACGroup15TextContent = "15"
        let iUPACGroup15Style = NSMutableParagraphStyle()
        iUPACGroup15Style.alignment = .center
        let iUPACGroup15FontAttributes = [
        ...
        //// IUPAC Group 16 Drawing
        let iUPACGroup16Rect = CGRect(x: 472, y: 0, width: 31, height: 17)
        let iUPACGroup16TextContent = "16"
        let iUPACGroup16Style = NSMutableParagraphStyle()
        iUPACGroup16Style.alignment = .center
        let iUPACGroup16FontAttributes = [
        ...
        //// IUPAC Group 17 Drawing
        let iUPACGroup17Rect = CGRect(x: 503, y: 0, width: 30, height: 17)
        let iUPACGroup17TextContent = "17"
        let iUPACGroup17Style = NSMutableParagraphStyle()
        iUPACGroup17Style.alignment = .center
        let iUPACGroup17FontAttributes = [
        ...
        //// IUPAC Group 18 Drawing
        let iUPACGroup18Rect = CGRect(x: 533, y: 0, width: 31, height: 17)
        let iUPACGroup18TextContent = "18"
        let iUPACGroup18Style = NSMutableParagraphStyle()
        iUPACGroup18Style.alignment = .center
        let iUPACGroup18FontAttributes = [
        ...
        //// IUPAC Group 8 Drawing
        let iUPACGroup8Rect = CGRect(x: 228, y: 0, width: 31, height: 17)
        let iUPACGroup8TextContent = "8"
        let iUPACGroup8Style = NSMutableParagraphStyle()
        iUPACGroup8Style.alignment = .center
        let iUPACGroup8FontAttributes = [
        ...
        //// IUPAC Group 9 Drawing
        let iUPACGroup9Rect = CGRect(x: 259, y: 0, width: 30, height: 17)
        let iUPACGroup9TextContent = "9"
        let iUPACGroup9Style = NSMutableParagraphStyle()
        iUPACGroup9Style.alignment = .center
        let iUPACGroup9FontAttributes = [
        ...
        //// IUPAC Group 10 Drawing
        let iUPACGroup10Rect = CGRect(x: 289, y: 0, width: 31, height: 17)
        let iUPACGroup10TextContent = "10"
        let iUPACGroup10Style = NSMutableParagraphStyle()
        iUPACGroup10Style.alignment = .center
        let iUPACGroup10FontAttributes = [
        ...
        //// legend alkali Drawing
        let legendAlkaliPath = UIBezierPath(rect: CGRect(x: 90, y: 36, width: 17, height: 17))
        PeriodicTableBackground.alkaliMetalsColor.setFill()
        legendAlkaliPath.fill()


        //// Alkali metals legend text Drawing
        let alkaliMetalsLegendTextRect = CGRect(x: 108, y: 36, width: 68, height: 17)
        let alkaliMetalsLegendTextTextContent = "Alkali metals"
        let alkaliMetalsLegendTextStyle = NSMutableParagraphStyle()
        alkaliMetalsLegendTextStyle.alignment = .left
        let alkaliMetalsLegendTextFontAttributes = [
        ...
        //// legend alkaline Drawing
        let legendAlkalinePath = UIBezierPath(rect: CGRect(x: 90, y: 53, width: 17, height: 18))
        PeriodicTableBackground.alkalineEarthMetalsColor.setFill()
        legendAlkalinePath.fill()


        //// Alkaline earth metals legend text Drawing
        let alkalineEarthMetalsLegendTextRect = CGRect(x: 108, y: 53, width: 118, height: 18)
        let alkalineEarthMetalsLegendTextTextContent = "Alkaline earth metals"
        let alkalineEarthMetalsLegendTextStyle = NSMutableParagraphStyle()
        alkalineEarthMetalsLegendTextStyle.alignment = .left
        let alkalineEarthMetalsLegendTextFontAttributes = [
        ...
        //// legend lanthanoid Drawing
        let legendLanthanoidPath = UIBezierPath(rect: CGRect(x: 90, y: 71, width: 17, height: 17))
        PeriodicTableBackground.lanthanoidsColor.setFill()
        legendLanthanoidPath.fill()


        //// Lanthanoids legend text Drawing
        let lanthanoidsLegendTextRect = CGRect(x: 108, y: 71, width: 68, height: 17)
        let lanthanoidsLegendTextTextContent = "Lanthanoids"
        let lanthanoidsLegendTextStyle = NSMutableParagraphStyle()
        lanthanoidsLegendTextStyle.alignment = .left
        let lanthanoidsLegendTextFontAttributes = [
        ...
        //// legend actinoid Drawing
        let legendActinoidPath = UIBezierPath(rect: CGRect(x: 90, y: 88, width: 17, height: 18))
        PeriodicTableBackground.actinoidsColor.setFill()
        legendActinoidPath.fill()


        //// Actinoids legend text Drawing
        let actinoidsLegendTextRect = CGRect(x: 108, y: 88, width: 68, height: 18)
        let actinoidsLegendTextTextContent = "Actinoids"
        let actinoidsLegendTextStyle = NSMutableParagraphStyle()
        actinoidsLegendTextStyle.alignment = .left
        let actinoidsLegendTextFontAttributes = [
        ...
        //// legend transition metals Drawing
        let legendTransitionMetalsPath = UIBezierPath(rect: CGRect(x: 208, y: 36, width: 18, height: 17))
        PeriodicTableBackground.transitionMetalsColor.setFill()
        legendTransitionMetalsPath.fill()


        //// Transition metals legen text Drawing
        let transitionMetalsLegenTextRect = CGRect(x: 227, y: 36, width: 93, height: 17)
        let transitionMetalsLegenTextTextContent = "Transition metals"
        let transitionMetalsLegenTextStyle = NSMutableParagraphStyle()
        transitionMetalsLegenTextStyle.alignment = .left
        let transitionMetalsLegenTextFontAttributes = [
        ...
        //// legend Post-transition metals Drawing
        let legendPosttransitionMetalsPath = UIBezierPath(rect: CGRect(x: 208, y: 53, width: 18, height: 18))
        PeriodicTableBackground.postTransitionMetalColor.setFill()
        legendPosttransitionMetalsPath.fill()


        //// Post-transition metals legend text Drawing
        let posttransitionMetalsLegendTextRect = CGRect(x: 227, y: 53, width: 109, height: 18)
        let posttransitionMetalsLegendTextTextContent = "Post-transition metals"
        let posttransitionMetalsLegendTextStyle = NSMutableParagraphStyle()
        posttransitionMetalsLegendTextStyle.alignment = .left
        let posttransitionMetalsLegendTextFontAttributes = [
        ...
        //// legend other nonmetals Drawing
        let legendOtherNonmetalsPath = UIBezierPath(rect: CGRect(x: 208, y: 71, width: 18, height: 17))
        PeriodicTableBackground.otherNonMetalsColor.setFill()
        legendOtherNonmetalsPath.fill()


        //// other nonmetals legend text Drawing
        let otherNonmetalsLegendTextRect = CGRect(x: 227, y: 71, width: 109, height: 17)
        let otherNonmetalsLegendTextTextContent = "Other nonmetals"
        let otherNonmetalsLegendTextStyle = NSMutableParagraphStyle()
        otherNonmetalsLegendTextStyle.alignment = .left
        let otherNonmetalsLegendTextFontAttributes = [
        ...
        //// legend noble glases Drawing
        let legendNobleGlasesPath = UIBezierPath(rect: CGRect(x: 208, y: 88, width: 18, height: 18))
        PeriodicTableBackground.nobleGasesColor.setFill()
        legendNobleGlasesPath.fill()


        //// noble gases legend text Drawing
        let nobleGasesLegendTextRect = CGRect(x: 227, y: 88, width: 109, height: 18)
        let nobleGasesLegendTextTextContent = "Noble gases"
        let nobleGasesLegendTextStyle = NSMutableParagraphStyle()
        nobleGasesLegendTextStyle.alignment = .left
        let nobleGasesLegendTextFontAttributes = [
        ...
        //// legend metalloids Drawing
        let legendMetalloidsPath = UIBezierPath(rect: CGRect(x: 336, y: 36, width: 17, height: 17))
        PeriodicTableBackground.metalloidsColor.setFill()
        legendMetalloidsPath.fill()


        //// metalloinds legend text Drawing
        let metalloindsLegendTextRect = CGRect(x: 354, y: 36, width: 57, height: 17)
        let metalloindsLegendTextTextContent = "Metalloids"
        let metalloindsLegendTextStyle = NSMutableParagraphStyle()
        metalloindsLegendTextStyle.alignment = .left
        let metalloindsLegendTextFontAttributes = [
        ...
        //// legend unknown Drawing
        let legendUnknownPath = UIBezierPath(rect: CGRect(x: 427, y: 36, width: 18, height: 17))
        PeriodicTableBackground.unknownColor.setFill()
        legendUnknownPath.fill()


        //// unknown legend text Drawing
        let unknownLegendTextRect = CGRect(x: 445, y: 36, width: 58, height: 17)
        let unknownLegendTextTextContent = "Unknown"
        let unknownLegendTextStyle = NSMutableParagraphStyle()
        unknownLegendTextStyle.alignment = .left
        let unknownLegendTextFontAttributes = [
